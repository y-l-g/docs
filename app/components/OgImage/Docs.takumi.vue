  ...
  >
    ...
    <div class="flex flex-col justify-between flex-1 px-20 py-16">
      ...
      <div class="flex items-center gap-4">
        <div class="size-8 rounded-md bg-primary-400 text-neutral-950 flex items-center justify-center font-bold text-xl">
          P
        </div>
        <div class="h-px flex-1 bg-border" />
        <span class="text-xl text-dimmed">Pogo FrankenPHP Plugins</span>
      </div>
    </div>
  </div>
</template>
